            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
<form id="form_validation" method="post" action="{{URL::to('siswa_update')}}/{{$lihat->id}}" enctype="multipart/form-data">
    {{ csrf_field() }}
...
<div class="form-group form-float">
    <div class="form-line">
         <input type="text" class="form-control" name="nis" value="{{$lihat->nis}}">
